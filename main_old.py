...
LOCAL_WORKSPACE_PATH = 'C:/Allen/TC Washer/yolov5-fastapi'
...
async def detect_object_json(file: bytes = File(...)):
    ...
    for img in results.ims:
        ...
        # local_pred_arr =  cv2.cvtColor(image_np_with_detections)
    ...
    return {"classes": detection_classes, "b64" : im_b64}
